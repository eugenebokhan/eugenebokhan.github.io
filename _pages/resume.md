...
* Design, implementation and maintaining of [Metal](https://developer.apple.com/metal/) pipeline infrastructure;
...
#### [Alloy](https://github.com/s1ddok/Alloy.git)
...
#### [Smelter](https://github.com/prisma-ai/Smelter.git)

Overhead-free ONNX graph inference engine with Metal under the hood.

#### [Swfit Snapshot Testing](https://github.com/eugenebokhan/swift-snapshot-testing)
...
#### [AssetImportKit](https://github.com/eugenebokhan/asset-import-kit.git)
