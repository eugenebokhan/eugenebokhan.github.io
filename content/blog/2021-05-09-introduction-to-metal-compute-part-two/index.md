...
Congratulations! You've written your first metal compute shader 🎉! In the [next chapter](@/blog/2021-05-10-introduction-to-metal-compute-part-three/index.md), we are going to write the encoder for this kernel.
